object FrmTelaPagtoEfetuado: TFrmTelaPagtoEfetuado
  Left = 311
  Top = 174
  Width = 545
  Height = 462
  ...
  object GroupBox3: TGroupBox
    ...
    Width = 521
    Height = 185
    Caption = 'Dados sobre Pagamentos por Venda Realizada'
    TabOrder = 2
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          Title.Caption = 'Valor Pagto (R$)'
          Width = 86
          Visible = True
        end
        item
          Expanded = False
          Title.Caption = 'Data do Pagto'
          Width = 77
          Visible = True
        end
        item
