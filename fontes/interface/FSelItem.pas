...
procedure TFrmSelItem.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    self.ClearBox;
    FrmTelaVenda.Enabled := true;
end;

Procedure TFrmSelItem.ListarCatg;
var
    DM   : TDM;
    Prod : Produto;
    Ct   : Controle;
Begin
    try
        ...
        begin
            ...
            FrmSelItem.Combobox1.Items.Add(Prod.getcatProd);
            DM.ZQuery1.Next;
        end;
...
procedure TFrmSelItem.ListarProdPorCatg;
var
    DM : TDM;
    Prod : Produto;
    Ct  : Controle;
Begin
    try
        ...
        Prod.setcatProd(FrmSelItem.Combobox1.Text);
        Ct.ListarProd;

        While (NOT DM.ZQuery1.EOF) do
        begin
            Prod.setnomeProd(DM.ZQuery1.FieldByName('nomeProd').AsString);
            FrmSelItem.Combobox2.Items.Add(Prod.getnomeProd);
            DM.ZQuery1.Next;
        end;
    Except
       MessageDlg('Problema na Listagem das categorias de produtos.', mtError, [mbOk], 0);
...
procedure TFrmSelItem.ClearBox;
begin
    Combobox1.Clear;
    Combobox2.Clear;
    ...
    FrmSelItem.BitBtn1.Enabled := false;
end;

procedure TFrmSelItem.ComboBox2Change(Sender: TObject);
var
    Prod : Produto;
    DM   : TDM;
    Ct   : Controle;
...
procedure TFrmSelItem.ComboBox1Change(Sender: TObject);
begin
...
procedure TFrmSelItem.habilitar;
begin
    self.Combobox2.Enabled := true;
...
procedure TFrmSelItem.BitBtn1Click(Sender: TObject);
var
    DM     : TDM;
    ItVend : ItemDeVenda;
    Ct     : Controle;
        ...
        begin
            ...
            begin
                ...
                begin
                    ...
                    FrmTelaVenda.CalcularVenda;
                    FrmTelaVenda.MostrarItens;
                    FrmTelavenda.BitBtn3.Enabled := true;
                    self.ClearBox;
...
procedure TFrmSelItem.MaiorCodigo;
var
    DM     : TDM;
    Ct     : Controle;
begin
...
procedure TFrmSelItem.BitBtn3Click(Sender: TObject);
var
    valorpago : real;
    preco : real;
    qtd   : real;
...
procedure TFrmSelItem.Edit6Change(Sender: TObject);
begin
    if(self.Edit2.Text = 'PESO') then
    begin
        try
...
procedure TFrmSelItem.FormShow(Sender: TObject);
begin
    self.BitBtn3.Enabled := false;
    self.ClearBox;
    self.MaiorCodigo;
...
procedure TFrmSelItem.Edit1Enter(Sender: TObject);
begin
    self.BitBtn3.SetFocus;
end;

procedure TFrmSelItem.Edit2Enter(Sender: TObject);
begin
    self.BitBtn3.SetFocus;
end;

procedure TFrmSelItem.CurrencyEdit1Enter(Sender: TObject);
begin
    self.BitBtn3.SetFocus;
end;

procedure TFrmSelItem.CurrencyEdit2Enter(Sender: TObject);
begin
    self.BitBtn3.SetFocus;
end;

procedure TFrmSelItem.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
    CanClose := self.PodeFechar;
end;

procedure TFrmSelItem.BitBtn2Click(Sender: TObject);
begin
    if MessageDlg('Deseja cancelar a seleção de itens de venda?', mtconfirmation, [mbYes, mbNo], 0) = mrYes then
    begin
        self.PodeFechar := true;
        self.Close;
    end
